...
Confirmed in rich ($\delta=1.00$, $p_\text{corr}\statPHthreeRich{}$) and medium
($\delta=1.00$, $p_\text{corr}\statPHthreeMedium{}$), where liberated ProtoOrganelle
...
Confirmed only in rich ($\delta=1.00$, $p_\text{corr}\statPHsixRich{}$), where V5
