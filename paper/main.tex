...
Under the default damage parameters (zero environmental damage), V1 does not
...
seeds~0--39) reveals that \textbf{69 of 84 conditions show a net V1 survival
...
protocells (V0--V3, $\mathrm{II}>0.15$) along this continuum.
