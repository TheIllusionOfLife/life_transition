...
Parameters were calibrated on seeds 0--49 targeting non-trivial population
...
Figure~\ref{fig:ii}; exact numbers will be reported after test-seed data
collection with the revised model [TBD].
...
H1 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H1 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H1 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H1 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
\multicolumn{7}{l}{\emph{H2: Viroid V0+V1+V2+V3 vs V0+V1+V2 (alive, more with V3)}} \\
H2 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H2 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H2 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H2 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
\multicolumn{7}{l}{\emph{H3: ProtoOrganelle liberated vs baseline (total\_replications)}} \\
H3 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H3 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H3 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H3 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
\multicolumn{7}{l}{\emph{H4: Viroid V0$\rightarrow$V3 monotonic trend (JT)}} \\
H4 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H4 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H4 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H4 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
\multicolumn{7}{l}{\emph{H5: Viroid V0..V4 vs V0..V3 (alive, more with V4)}} \\
H5 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H5 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H5 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H5 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
\multicolumn{7}{l}{\emph{H6: Viroid V0..V5 vs V0..V4 (alive, more with V5)}} \\
H6 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H6 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H6 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H6 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\midrule
...
H8 & rich   & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H8 & medium & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H8 & sparse & [TBD] & [TBD] &     & [TBD] & [TBD] \\
H8 & scarce & [TBD] & [TBD] &     & [TBD] & [TBD] \\
\bottomrule
\end{tabular}%
}
\end{table}

\textbf{H1} (boundary cost--benefit tradeoff) results will be updated after
test-seed data collection with the revised model [TBD].
With the addition of energy leakage and environmental damage mechanics,
V1 is expected to show an environment-dependent tradeoff: net cost in
resource-rich environments (where leakage/damage pressure is low relative
to repair costs) but net benefit in harsh environments (where boundary
protection against damage outweighs the repair overhead).
Calibration seeds (0--49) confirmed this tradeoff pattern.

\textbf{H2} (metabolism buffering) results will be updated after
test-seed data collection with the revised model [TBD].
V3 addition is expected to remain the most transformative capability step,
with mean alive rising substantially when internal resource conversion is added.

\textbf{H3} (liberation) results will be updated after test-seed data
collection with the revised model [TBD].
In the prior model, liberation was confirmed in rich/medium but null in
sparse/scarce, where the resource pool was too depleted for the higher
replication threshold~(0.80).

\textbf{H4} (monotonic trend) results will be updated [TBD].
With the revised V1/V2 mechanics, the non-monotonic ``cost valley'' is
expected to be shallower: V1 may help in harsh environments, creating
a more nuanced alive pattern across V-levels.
The Jonckheere-Terpstra test detects overall upward tendency (V0 to V3)
...
\textbf{H5} (chemotaxis benefit) results will be updated [TBD].
V4 chemotaxis is expected to improve survival where resources are heterogeneous
but incur a net cost in resource-rich environments where the per-step movement
cost ($0.01 \times |\Delta\mathbf{v}|$) outweighs the foraging benefit.
This would reveal a \emph{second cost valley}: behavioural capabilities incur
overhead that is only justified when the environment rewards directed movement.

\textbf{H6} (lifecycle staging) results will be updated [TBD].
V5 dormancy is expected to enable energy conservation during transient
low-resource periods in rich environments, but to \emph{reduce} survival
in harsher environments where dormancy phases suppress replication windows
and dispersal's elevated energy decay ($\times 1.5$) is counterproductive.

\textbf{H7} (full monotonic trend V0--V5) results will be updated [TBD].
Despite expected non-monotonic pairwise reversals in H5 and H6, the overall
six-level trend V0$\to$V5 is predicted to remain robustly upward: the V3
metabolism recovery dominates the signal, and V4/V5 additions, while
environment-dependent, should not reverse the aggregate trajectory.

\textbf{H8} (V2 overconsumption regulation, Amendment~3) results will be
updated after test-seed data collection with the revised model [TBD].
Calibration data show that V2 regulation reduces overconsumption waste,
providing a measurable survival advantage over V0+V1 alone.
...
\emph{Exploratory}: The alive-count metric used in H1--H8 may exhibit
ceiling/floor effects, raising the concern that the metric is too coarse
to distinguish strong from overwhelming effects.
...
regulation), we expect effect sizes to span a wider range than the prior
model's saturated $\delta=1.00$ values [TBD].
The sensitivity analysis (\S\ref{sec:sensitivity}) provides additional
evidence on whether conclusions are robust to parameter perturbation.
...
is expected to remain significant [TBD]: the V3 metabolic recovery
is predicted to dominate the aggregate signal.

The H3 ProtoOrganelle liberation result is expected to be environment-dependent:
in resource-rich conditions, adding V0 replication to a metabolically complete
entity (V1+V2+V3) should produce a replicating population [TBD]; in sparse/scarce
