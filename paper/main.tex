...
Under the default damage parameters, V1 does not produce a net positive
effect at any harshness level; higher damage regimes may shift this
balance (a V1 protection-regime sweep is planned as future work).
However, V1 entities that survive show \emph{higher mean energy}
