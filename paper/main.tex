...
\item[\textbf{H4}] \emph{Monotonic V0--V3}: alive increases across four
  ...
  at intermediate V-levels are present (Section~\ref{sec:results-phase}).}
...
($\delta\!=\!1.00$, all $p_\text{corr}\!<\!10^{-33}$): V3 transforms survival,
...
with serial endosymbiosis scenarios \citep{maturana_1980_autopoiesis}.
...
\citet{godfreysmith_2013_philosophy}'s distinction between ``paradigm'' and
