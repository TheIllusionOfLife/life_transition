...
combining energy, regulation, behaviour, and lifecycle channels---a continuous
axis from virus-like ($\mathrm{II}\!\approx\!0$) to life-like ($\mathrm{II}\!>\!0$).
...
protection benefit) and is near-neutral in sparse/scarce environments
(where boundary cost approximately offsets the protection benefit---consistent
with the tradeoff rather than V1 being ineffective).
...
SemiLife entities share the resource field with organisms but do not
