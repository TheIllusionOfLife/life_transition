...
survival boundaries shift with each added capability, making the
virus-to-life transition operationally measurable without a host organism.
Results and effect sizes for all pre-registered comparisons are reported
