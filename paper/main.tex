...
V0+V1+V2 activates the regulation channel ($\mathrm{II}_R > 0$), producing the
first non-zero composite II---a key difference from the prior single-channel
formulation where V0--V2 all had $\mathrm{II}=0$.
...
H5 & rich   & 238    & $<\!10^{-30}$ & *** & $-$0.95 [$-$0.99, $-$0.91] & \texttimes \\
H5 & medium & 9\,998 & $<\!10^{-33}$ & *** & 1.00 [1.00, 1.00] & \checkmark \\
...
H6 & rich   & 10\,000 & $<\!10^{-33}$ & *** & 1.00 [1.00, 1.00] & \checkmark \\
H6 & medium & 1\,412 & $<\!10^{-17}$ & *** & $-$0.72 [$-$0.81, $-$0.61] & \texttimes \\
H6 & sparse & 27     & $<\!10^{-33}$ & *** & $-$0.99 [$-$1.00, $-$0.99] & \texttimes \\
H6 & scarce & 50     & $<\!10^{-37}$ & *** & $-$0.99 [$-$1.00, $-$0.97] & \texttimes \\
\midrule
\multicolumn{7}{l}{\emph{H7: Viroid V0$\rightarrow$V5 monotonic trend (JT)}} \\
H7 & rich   & 39\,881 & $<\!10^{-100}$ & *** & --- & \checkmark \\
H7 & medium & 34\,721 & $<\!10^{-100}$ & *** & --- & \checkmark \\
H7 & sparse & 41\,573 & $<\!10^{-100}$ & *** & --- & \checkmark \\
H7 & scarce & 50\,050 & $<\!10^{-100}$ & *** & --- & \checkmark \\
\midrule
...
rich ($\delta=-0.95$, $p_\text{corr}<10^{-30}$).
V4 chemotaxis improves survival where resources are heterogeneous:
mean alive rises from 53.4 to 86.0 in medium ($+61\%$) and from 20.0 to 35.9
in sparse ($+80\%$).
...
survival from 199.1 to 152.2 ($-24\%$).
...
during transient low-resource periods, pushing mean alive from 152.2 to 204.7
($+34\%$).
In medium ($\delta=-0.72$), sparse ($\delta=-0.99$), and scarce
